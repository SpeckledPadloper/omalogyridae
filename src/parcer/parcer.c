...
/*   Updated: 2022/09/28 20:17:11 by mteerlin      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// 		dquote = set_quote_state(dquote, temp, sep);
...
void	expand_variables(t_split_cmd_rdir *head, char ***env)
{
	...
	expand_section(&head->cmd_head, env);
	printf("commands expanded\n");
	expand_section(&head->in_head, env);
	printf("infiles expanded\n");
	expand_section(&head->out_head, env);
	printf("outfiles expanded\n");
}
